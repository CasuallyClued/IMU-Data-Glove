 ...
 *  Modified by Kamal Gamir-Shahin for additional functionality for
 *  prototype 1
...
////////// NEW DEFINITIONS (KAMAL GAMIR-SHAHIN) /////
struct G_Values
{
  float x;
  float y;
...
public:
  ...
  // Custom functions (Kamal Gamir-Shahin)
  G_Values g_values;
  void get_g_values(G_Values *g_values);
