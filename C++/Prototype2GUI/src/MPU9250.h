...
public:
  ...
  public:
    ...
    float magCalibration[3] = {0, 0, 0}, magias[3] = {0, 0, 0};
    ...
    void init_single(int ADpin);
    void get_IMUdata_single(int ADpin);
    void do_all_single(int ADpin);
    IMU_Values accvals;
    IMU_Values angvals;
    IMU_Values magvals;
    void get_IMUvalues(IMU_Values *accvals, IMU_Values *angvals, IMU_Values *magvals);
